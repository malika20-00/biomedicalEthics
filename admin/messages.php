...
<head>
    ...
    <!-- <link rel="stylesheet" href="./asserts/css/messages.css"> -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css" integrity="sha512-KfkfwYDsLkIlwQp6LFnl8zNdLGxu9YAA1QvwINks4PhcElQSvqcyVLLD9aMhXd13uQjoXtEKNosOWaZqXgel0g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="./asserts/css/MssgStyle.css" />

    <!-- <link rel="stylesheet" href="RepStyle.css" type="text/css"> -->
                    ...
                    <div id="body-message">
                        ...
                        <div id="grille"  class="insights" >
                            ...
                            while($article=$resultat->fetch(PDO::FETCH_OBJ)){
                                $id= $article->idmssg;
                                ?>
                                <section class="section-grid" id="<?php echo $id;?>">
                                        <div class="container">
                                            <div class="content">
                                                <div class="card">
                                                    <div class="card-content">
                                                        <div class="image">
                                                            <img src="./asserts/mssg.png" alt="">
                                                        </div>
                                                        ...
                                                        <div class="name-profession">
                                                            <div class="name"><?php  echo $article->nom;  echo  " ".$article->prenom; ?></div>
                                                            <div class="gmail"> <?php    echo $article->email;    ?></div>
                                                            <div class="message"><?php      echo $article->message;?>  </div>
                                                        </div>
                                                    ...
                                                    <div class="button">
                                                            <div class="but-Rep">
                                                                <a href="reponse.php?id=<?php  echo $id;?>"> répondre</a></div>
                                                            <div class="but-Supp"> <p onclick="supprimerMessage(<?php  echo $id;?>)" >Supprimer</p></div>
                                                    </div>
                                                </div>
                                            </div>
