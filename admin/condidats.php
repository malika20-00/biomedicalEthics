      ...
      <main>
            ...
            <div class="insights">
                ...
                <tbody>
                    ...
                    ?>
                    <tr id="<?php  echo $id;?>">
                    <td class="profile-photo"> <?php
                     $photo=$article->photoProfil;
                     $chemin='../photoProfil/'.$photo;
                     ?> 
                    <img class="img" src="<?php echo $chemin;?>"  alt="photoProfil"> 
                    </td>
                    <td><?php  echo $article->nom;
                   echo  " ".$article->prenom; ?> 
                   </td>
                    <td> <?php
                     echo $article->email;
                    ...
                    echo $article->etablissement;?>
                     </td>
                    <td> <?php
                     echo $article->specialite;
                    ?> </td>
                    <td > <?php
                     echo $article->dateNaissance;
                    ?>        </td>
                    <td>  <p class="primary" onclick="refuserUser(<?php  echo $id;?>)" >supprimer</p></td>
                     </tr>
                    <?php } ?>
                    </tbody>
                 </table>
